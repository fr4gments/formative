export const IKAL_SEED_ROOTS = [
  ...
  {
    aliases: ["ton", "tone", "resonant", "resonance"],
    cr: "mžv",
    domain: "music",
    family: "tone",
    form: "amžvala",
    section: "4.5.1.1 Various Types of Sounds",
    sense: "sonorous/resonant sound",
    timbre: "resonant",
  },
  {
    aliases: ["cloche", "bell", "metal", "metallique"],
    cr: "žb",
    domain: "music",
    family: "tone",
    form: "žbala",
    section: "4.5.1.1 Various Types of Sounds",
    sense: "sound of ringing/chiming/clanging",
    timbre: "bell",
  },
  {
    aliases: ["drone", "nappe", "bourdon", "sombre"],
    cr: "řż",
    domain: "music",
    family: "tone",
    form: "ařżala",
    section: "4.5.1.1 Various Types of Sounds",
    sense: "sound of a low hum/whir/rumble",
    timbre: "dark",
  },
  {
    aliases: ["blip", "bip", "beep", "electronique"],
    cr: "žd",
    domain: "music",
    family: "tone",
    form: "ždala",
    section: "4.5.1.1 Various Types of Sounds",
    sense: "sound of a zap/buzz/beep/ping",
    timbre: "crystal",
  },
  {
    aliases: ["chant", "voix", "voice", "sing"],
    cr: "lly",
    domain: "music",
    family: "tone",
    form: "allyala",
