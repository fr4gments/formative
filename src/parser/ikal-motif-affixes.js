...
// (nb de notes = Configuration, accord/arpège = Function, octave = Stem,
//  consonance = Affiliation : ça, c'est de la vraie morphologie, pas ici.)
...
export function motifShapeFromAffixes(slotVII = [], { stem = 1, count = 1, deploy = "sequence" } = {}) {
