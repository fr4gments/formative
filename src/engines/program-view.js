...
function controlsFromParams(params = {}) {
  ...
  return {
    ...
    colorShift: clamp01(visual.colorShift || 0),
    contrastBoost: clamp01(visual.contrast || 0),
    darkness: clamp01(visual.darkness || 0),
    diffusion: clamp01(visual.diffusion || 0),
    deformation: clamp01(visual.deformation || 0),
    density: clamp01(Math.max(densityForMultiplicity(params.multiplicity), visual.density || 0)),
