...
La version en cours travaille l'etape 5 : modes explicites, routage par mode, autocompletion contextuelle, puis composition visuelle intra-couche.
...
- le prototype `mot(...)` reste disponible pour tester l'inspecteur et certaines valeurs continues, mais il n'est pas la syntaxe finale ;
...
- [Parametres artistiques](params.md) : contrat `ithkuil` vers `params`, avec les affixes audio et le prototype positionnel.
